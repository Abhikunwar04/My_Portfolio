...
/* tuning */
const stiffness = 0.22; // speed
const damping = 0.72;   // smoothness

// sizes (center fix ke liye)
const dotSize = 6;
const ringSize = 38;

// DOT instant follow (CENTER FIXED)
...
// SMOOTH RING (spring physics + CENTER FIX)
...
// HOVER EFFECT
document.querySelectorAll("a, button, .hover-target, .skill-card, .project-card").forEach(el => {
