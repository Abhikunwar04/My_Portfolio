...
function canvasResize() {
  ...
  mc = null;
  // Direct canvasDraw call hatayi — RAF loop khud handle karega
}
...
if (!nameEntryStart) {
  // nameEntryStart set mat karo yahan — sirf canvasInit/RAF se set hoga
  nameEntryProgress = 0;
  return; // ← early return, draw mat karo jab tak start nahi hua
}
