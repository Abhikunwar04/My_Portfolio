...
vL.addColorStop(0, 'rgba(0,0,0,0.15)');
...
vR.addColorStop(0, 'rgba(0,0,0,0.12)');
vR.addColorStop(1, 'rgba(0,0,0,0)');
ctx.fillStyle = vR;
ctx.fillRect(0, 0, W, H);

// TOP (very subtle)
const topA = clamp(1 - p * 2, 0, 0.15);
...
// GLOBAL DARK OVERLAY (major fix)
const darkAlpha = clamp((p - 0.35) / 0.55, 0, 0.25);
