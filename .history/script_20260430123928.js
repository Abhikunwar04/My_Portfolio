...
// Scroll ke saath neeche jaana — 0 se start, p badhne pe neeche
const scrollOffsetY = p * H * 0.35;

// Entry: upar se mid mein
const entryStartY = -nameH;
const entryEndY   = H * 0.50 - nameH / 2;

// Entry ke baad mid position + scroll offset
...
const nameAlpha = nameEntryDone
  ? clamp(1 - (p - 0.5) / 0.4, 0, 1)  // scroll ke saath fade out
  : entryT;
